...
- React 19, TypeScript (tsgo), Vite 8 (Rolldown/Oxc), Ant Design 6, Zustand, React Router 7.
- `@vitejs/plugin-react-swc` — **never switch to Babel plugin**.
