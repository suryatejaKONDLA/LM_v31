...
using CITL.Infrastructure.Core.Admin.Mappings;
using CITL.Infrastructure.Core.Authentication;
using CITL.Infrastructure.Core.Common;
...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IFinYearMasterRepository, FinYearMasterRepository>();
        services.AddScoped<ILoginMasterRepository, LoginMasterRepository>();
