 ...
 * Consumers should render `<GlobalSpinnerHolder />` once and control
 * visibility via `GlobalSpinner.show()` / `GlobalSpinner.hide()`.
 *
 * For most cases prefer the declarative `<Spinner loading={…} />` component.
 */
